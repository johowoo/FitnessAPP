    ...
    return (
      <LinearGradient colors={["#1b98d9", "#57c5b8"]} style={{ flex: 1 }}>
        ...
        <WorkoutList
          ...
          workoutSetsData={
            this.props.customWorkoutSets[navProps.selectedExerciseCategory]
          }
          currentWorkout={
            this.props.customWorkoutSets[navProps.selectedExerciseCategory]
          }
          ...
          setAddWeightModalVisibility={
            this.props.setEditLibraryAddWeightModalVisibility
          }
          setEditWeightRepsModalVisibility={
            this.props.setEditLibraryEditWeightRepsModalVisibility
          }
          //todo
          selectedExerciseCategory={navProps.selectedExerciseCategory}
          addWeightRepsToExercise={props =>
            this.props.addWeightRepsToExerciseInLibrary({
              ...props,
              selectedExerciseCategory: navProps.selectedExerciseCategory,
            })
          }
          editWeightRepsInWorkout={props =>
            this.props.editWeightRepsInWorkoutOfLibrary({
              ...props,
              selectedExerciseCategory: navProps.selectedExerciseCategory,
            })
          }
          deleteExerciseFromWorkoutList={props =>
            this.props.deleteExerciseFromWorkoutListOfLibrary({
              ...props,
              selectedExerciseCategory: navProps.selectedExerciseCategory,
            })
          }
        ...
        <ExerciseModal
          ...
          addExercise={props =>
            this.props.addExerciseFromExerciseModalToCategoryOfLibrary({
              ...props,
              selectedExerciseCategory: navProps.selectedExerciseCategory,
            })
          }
...
const mapStateToProps = state => ({
  ...
  showExerciseModalForEditLibrary:
    state.editLibrary.showExerciseModalForEditLibrary,
  showAddWeightModalForEditLibrary:
    state.editLibrary.showAddWeightModalForEditLibrary,
  showEditWeightRepsForEditLibrary:
    state.editLibrary.showEditWeightRepsForEditLibrary,
});
