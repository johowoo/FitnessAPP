...
export class EditWeightReps extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({ selectedSets: this.props.sets });
  }
  ...
  componentWillMount() {
    ...
    for (let i = 0; i < this.props.weightRepsDataArr.length; i++) {
      weightTextTmp[i] = this.props.weightRepsDataArr[i]
        ? this.props.weightRepsDataArr[i].weight
        : 0;
      repsTextTmp[i] = this.props.weightRepsDataArr[i]
        ? this.props.weightRepsDataArr[i].reps
        : 0;
    }
    this.setState({
  ...
  render() {
    const newWeightRepsDataArr = JSON.parse(
      JSON.stringify(this.props.weightRepsDataArr)
    );
                    ...
                    <View
                      ...
                      <TextInput
                        ...
                        onChangeText={
                          //阻止主动重新渲染
                          text => {
                            const weightText = JSON.parse(
                              JSON.stringify(this.state.weightText)
                            );
                      ...
                      <TextInput
                        ...
                        onChangeText={text => {
                          const repsText = JSON.parse(
                            JSON.stringify(this.state.repsText)
                          );
                          repsText[index] = text;
                          this.setState({
                            repsText,
