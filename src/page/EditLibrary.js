...
export class _EditLibrary extends Component {
  ...
  handleConfirm = async () => {
    ...
    await this.props.deleteCategoryFromEditLibrary(
        ...
        <TouchableOpacity
          ...
          onPress={async () => {
            ...
            await this.props.navigation.navigate("EditExercisesForLibrary", {
              selectedExerciseCategory: item,
              setEditLibraryExerciseModalVisibility: this.props
                .setEditLibraryExerciseModalVisibility,
            });
          }}>
            ...
            <ApslButton
              onPress={async () => {
                ...
                await this.setState({
                  ...
                  reminderContent:
                    "Do you want to delete this category from library?",
                });
              }}
              ...
              children={
                <Icon name="cancel" size={34} color={"#FF6600"} key="cancel" />
              }
            />
          )}
        </TouchableOpacity>
      ...
      <LinearGradient colors={["#219dd5", "#51c0bb"]} style={{ flex: 1 }}>
        <ScrollView>
          <View style={styles.instructionTextContainer}>
            <Text style={styles.instructionText}>
              click to edit exercises for specific category
            </Text>
            <Text style={styles.instructionText}>
        ...
        <AddCategoryModal
          ...
          setAddCategoryModalForLibraryVisibility={
            this.props.setAddCategoryModalForLibraryVisibility
          }
