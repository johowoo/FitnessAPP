...
class _EditHistory extends Component {
  ...
  handleReminderConfirm = async () => {
    ...
    await this.props.setReminderModalInEditHistory({
  ...
  render() {
    ...
    return (
      <LinearGradient colors={["#219dd1", "#51c0bb"]} style={{ flex: 1 }}>
        ...
        <View>
          <Text style={styles.dateTitle}>{navProps.date}</Text>
        </View>
        <WorkoutList
          ...
          setAddWeightModalVisibility={
            this.props.setCalendarEditHistoryAddWeightModalVisibility
          }
          setEditWeightRepsModalVisibility={
            this.props.setCalendarEditHistoryEditWeightRepsModalVisibility
          }
          addWeightRepsToExercise={props =>
            this.props.addWeightRepsToExerciseInCalendarHistory({
              ...props,
              date: navProps.date,
            })
          }
          editWeightRepsInWorkout={props =>
            this.props.editWeightRepsInWorkoutOfCalendarHistory({
              ...props,
              date: navProps.date,
            })
          }
          deleteExerciseFromWorkoutList={async props => {
            ...
            await this.props.navigation.setParams({
              checkButtonAvailabilitySets: this.props
        ...
        {this.props.showReminderModal && (
          <ReminderModal
            ...
            handleCloseReminder={() =>
              this.props.setReminderModalInEditHistory({
                showReminderModal: false,
              })
            }
...
const mapStateToProps = state => ({
  ...
  showAddWeightModalForEditHistory:
    state.calendar.showAddWeightModalForEditHistory,
  showEditWeightRepsForEditHistory:
    state.calendar.showEditWeightRepsForEditHistory,
  ...
  workoutHistoryExerciseList:
    state.editHistoryExercisesList.workoutHistoryExerciseList,
...
export const EditHistory = connect(
  mapStateToProps,
  mapActionToProps
)(_EditHistory);
