              ...
              onDayPress={day => {
                ...
                if (!this.props.markedDates.hasOwnProperty(date)) {
                  this.props.navigation.navigate("EditHistory", {
                    date,
                    setEditHistoryExerciseModalVisibility: this.props
                      .setEditHistoryExerciseModalVisibility,
                    setReminderModalInEditHistory: this.props
                      .setReminderModalInEditHistory,
