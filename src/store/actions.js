...
export const resetCustomWorkoutAddableAction = data =>
  createAction(types.RESET_CUSTOM_WORKOUT_ADDABLE)(data);
...
export const addExerciseFromExerciseModalToCategoryOfLibraryAction = data =>
  createAction(types.ADD_EXERCISE_FROM_EXERCISE_MODAL_TO_CATEGORY_OF_LIBRARY)(
    data
  );
...
export const setCalendarEditHistoryAddWeightModalVisibilityAction = data =>
  createAction(types.SET_CALENDAR_EDIT_HISTORY_ADD_WEIGHT_MODAL_VISIBILITY)(
    data
  );
export const setCalendarEditHistoryEditWeightRepsModalVisibilityAction = data =>
  createAction(
    types.SET_CALENDAR_EDIT_HISTORY_EDIT_WEIGHT_REPS_MODAL_VISIBILITY
  )(data);
...
export const editWeightRepsInWorkoutOfCalendarHistoryAction = data =>
  createAction(types.EDIT_WEIGHT_REPS_IN_WORKOUT_OF_CALENDAR_HISTORY_ACTION)(
    data
  );
...
export const deleteExercisesFromExerciseListOfWorkoutHistoryAction = data =>
  createAction(types.DELETE_EXERCISES_FROM_EXERCISE_LIST_OF_WORKOUT_HISTORY)(
    data
  );
